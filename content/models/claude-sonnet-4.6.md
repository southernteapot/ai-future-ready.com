...
A 93/100 coding score puts Sonnet in striking distance of frontier models that cost two to three times as much. It's faster than the Opus tier (82 vs low-60s speed scores), and the writing quality at 92/100 means you're not sacrificing much for the speedup. For the vast majority of coding, analysis, and content work, Sonnet handles it without breaking a sweat.
...
**When to pick something else:** When the task genuinely requires the last 5% of capability -- complex multi-file refactors, intricate reasoning chains -- upgrade to Opus 4.8. For high-volume, cost-sensitive workloads where quality can flex a bit, Haiku 4.5 at $1/$5 or Gemini 3 Flash at $0.50/$3.00 will save you serious money.
